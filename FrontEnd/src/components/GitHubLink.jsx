...
const REPO_URL = 'https://github.com/Aryaen-Sharma/IssueTracker'
...
/**
 * Link out to the source repo. `variant="icon"` is the compact version used
 * in the top bar; the default is a labelled link for the login screen.
 */
const GitHubLink = ({ variant = 'text' }) => {
  if (variant === 'icon') {
    return (
      <a
        className="github-link github-link-icon"
        href={REPO_URL}
        target="_blank"
